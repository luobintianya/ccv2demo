 ...
 */
package com.deloitte.cx.acccore.constants;

/**
 * Global class for all Customeracccore constants. You can add global constants for your extension into this class.
 */
public final class CustomeracccoreConstants extends GeneratedCustomeracccoreConstants
{
	public static final String EXTENSIONNAME = "customeracccore";


	private CustomeracccoreConstants()
	{
		//empty
	}
