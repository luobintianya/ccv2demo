 ...
 *
 */
package com.deloitte.cx.oms.actions.consignment;

import de.hybris.platform.ordersplitting.model.ConsignmentProcessModel;
import de.hybris.platform.processengine.BusinessProcessEvent;
import de.hybris.platform.processengine.BusinessProcessService;
import de.hybris.platform.processengine.action.AbstractProceduralAction;
import com.deloitte.cx.oms.constants.CustomeraccomsConstants;
...
public class ConsignmentProcessEndAction extends AbstractProceduralAction<ConsignmentProcessModel>
{
	...
	public void executeAction(final ConsignmentProcessModel process)
	{
		...
		final String eventId =
				process.getParentProcess().getCode() + "_" + CustomeraccomsConstants.ORDER_ACTION_EVENT_NAME;
		...
		LOG.debug("Process: {} fired event {}", process.getCode(), CustomeraccomsConstants.ORDER_ACTION_EVENT_NAME);
	}
}
