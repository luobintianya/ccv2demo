...
public class ReAllocateConsignmentActionTest
{
	...
	public void setup()
	{
		...
		when(orderBusinessProcessService
				.createProcess(anyString(), eq(CustomeraccomsConstants.CONSIGNMENT_SUBPROCESS_NAME)))
		...
		doNothing().when(orderBusinessProcessService)
				.triggerChoiceEvent(orderModel, CustomeraccomsConstants.ORDER_ACTION_EVENT_NAME,
