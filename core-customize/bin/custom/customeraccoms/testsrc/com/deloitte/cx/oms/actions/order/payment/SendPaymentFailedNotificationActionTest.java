 ...
 *
 */
package com.deloitte.cx.oms.actions.order.payment;
...
import com.deloitte.cx.oms.actions.order.payment.SendPaymentFailedNotificationAction;
...
public class SendPaymentFailedNotificationActionTest
{
	...
	/**
	 * Test method for
	 * {@link com.deloitte.cx.oms.actions.order.SendPaymentFailedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
