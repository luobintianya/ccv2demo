...
public class ReturnIntegrationTest extends BaseAcceleratorSourcingIntegrationTest
{
			...
			throws RetryLaterException, InterruptedException, ImpExException
	{
		...
		importCsv("/customeraccoms/test/impex/email-content.impex", WarehousingTestConstants.ENCODING);
		importCsv("/customeraccoms/test/impex/email-content_en.impex", WarehousingTestConstants.ENCODING);
