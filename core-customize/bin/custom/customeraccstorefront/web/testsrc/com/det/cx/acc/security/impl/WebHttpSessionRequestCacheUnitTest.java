...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/customeraccstorefront/electronics/en",
						"https://electronics.local:9002/customeraccstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/customeraccstorefront/electronics/en",
						"https://electronics.local:9002/customeraccstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/customeraccstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/customeraccstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/customeraccstorefront/electronics/en",
						"https://electronics.local:9002/customeraccstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/customeraccstorefront",
						"https://electronics.local:9002/customeraccstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/customeraccstorefront",
						"https://electronics.local:9002/customeraccstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/customeraccstorefront/electronics/en",
						"https://electronics.local:9002/customeraccstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
